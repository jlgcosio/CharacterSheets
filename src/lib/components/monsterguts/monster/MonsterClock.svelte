...
<label class="form-control flex-1">
	...
	<div class=" flex gap-2">
		<div class="join">
			<input type="number" class="input join-item input-bordered max-w-16" bind:value={current} />
			<div class="input join-item input-bordered flex items-center justify-center p-4">
				<span>/</span>
			</div>
			<input type="number" class="input join-item input-bordered max-w-16" bind:value={max} />
